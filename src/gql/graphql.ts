...
/** To have author-related properties [See type definition](https://app.contentful.com/spaces/p23lsndwnwwk/content_types/componentAuthor) */
...
/** To describe an image used in rich text fields [See type definition](https://app.contentful.com/spaces/p23lsndwnwwk/content_types/componentRichImage) */
...
/** To have SEO-related properties to the pages we render [See type definition](https://app.contentful.com/spaces/p23lsndwnwwk/content_types/componentSeo) */
...
/** To create individual blog posts [See type definition](https://app.contentful.com/spaces/p23lsndwnwwk/content_types/pageBlogPost) */
...
/** To have an entry point for the app (e.g. Homepage) [See type definition](https://app.contentful.com/spaces/p23lsndwnwwk/content_types/pageLanding) */
...
export type PostCardQueryVariables = Exact<{
  id: Scalars["String"];
}>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "pageLanding" },
            arguments: [
              {
                kind: "Argument",
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "featuredBlogPost" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      {
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "pageBlogPost" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "shareImagesCollection" },
                        arguments: [
                          {
                            kind: "Argument",
...
} as unknown as DocumentNode<PostCardQuery, PostCardQueryVariables>;
